...
public class AddressBook {
    ...
    // These are properties to replace string[] person with a HashMap
    ...
    private static final String COMMAND_SORT_DESC = "List address book temporarily for this session sorted based on name.";
    ...
    private static String executeSortPersonsInAddressBook() {
        ...
        sortListByName(toBeDisplayed);
        showToUser(toBeDisplayed);
        return getMessageForPersonsDisplayedSummary(toBeDisplayed);
    }

    private static void sortListByName(ArrayList<HashMap<String, String>> listOfPeople) {
        Collections.sort(listOfPeople, new Comparator<HashMap<String, String>>(){
                    public int compare(HashMap<String, String> one, HashMap<String, String> two) {
                        return one.get(PERSON_PROPERTY_NAME).compareTo(two.get(PERSON_PROPERTY_NAME));
                    }});
    }
